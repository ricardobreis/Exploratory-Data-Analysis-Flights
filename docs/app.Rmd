...
```{r}
meses <- data.frame("1" = "Jan", "2" = "Fev", "3" = "Mar", "4" = "Abr", "5" = "Mai", "6" = "Jun", "7" = "Jul")

filtered_map_comparative <- reactive({
  subset(uf, emprs_s %in% input$companhia_checkbox & ms_fctr %in% meses[seq(input$mes_slider[1]:input$mes_slider[2])])
})
